...
export function LessonAssessmentScreen({ lessonId, data }: LessonAssessmentScreenProps) {
    ...
    const requestLeaveLesson = () => setShowLeaveDialog(true);
    const leaveLessonDialog = (
        <LeaveLessonDialog
                ...
                <div className="flex min-h-screen justify-center bg-parchment px-0 py-0 sm:px-4 sm:py-6 lg:px-6 lg:py-10">
                    <div className="flex min-h-screen w-full max-w-[1024px] flex-col bg-[#F0FAF0] shadow-[0_0_0_1px_rgba(224,217,206,0.4)] sm:min-h-[900px]">
                        ...
                        <div className="px-4 pt-4 sm:px-8 sm:pt-6 lg:px-12">
                            <AssessmentBackButton onClick={requestLeaveLesson} />
                        </div>
    ...
    return (
        <>
            <div className="flex min-h-screen justify-center bg-parchment px-0 py-0 sm:px-4 sm:py-6 lg:px-6 lg:py-10">
                <div className="flex min-h-screen w-full max-w-[1024px] flex-col items-center bg-parchment px-4 pb-16 pt-4 shadow-[0_0_0_1px_rgba(224,217,206,0.4)] sm:min-h-[900px] sm:px-8 sm:pb-24 sm:pt-6 lg:px-12 lg:pb-[331px]">
