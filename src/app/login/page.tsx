        ...
        <div className="flex flex-col justify-center items-center ">
            ...
            <main className="flex w-full flex-col gap-3 px-6 mt-20">
                {roles.map((role, index) => (
                    <a href={`/login/${role.name.toLowerCase()}`} key={index} className="flex items-center justify-between py-6.5 px-5.25 border border-[#E0D9CE] cursor-pointer hover:bg-indigo-5 hover:border-2 hover:border-indigo transition-colors rounded-xl">
