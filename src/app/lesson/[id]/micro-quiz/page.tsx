...
type PageProps = {
    ...
    searchParams: Promise<{ index?: string; stage?: string }>;
};
...
export default async function LessonMicroQuizPage({ params, searchParams }: PageProps) {
    ...
    const stageKey = resolvedSearchParams.stage;

    return <LessonMicroQuizRoute lessonId={id} index={index} stageKey={stageKey} />;
}
